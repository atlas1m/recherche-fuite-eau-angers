...
NAV = '<header class="nav"><div class="wrap navin"><a class="brand" href="/recherche-fuite-eau-angers/"><span class="mark">RF</span><span>Recherche Fuite Angers</span></a><nav class="links"><a href="/recherche-fuite-eau-angers/">Guide</a><a href="/recherche-fuite-non-destructive-angers/">Non destructif</a><a href="/recherche-fuite-assurance-angers/">Assurance</a><a href="/prix-recherche-fuite-eau-angers/">Prix</a><a class="btn phone-primary" href="tel:+339****5577">Appeler le 09 72 14 55 77</a><a class="nav-form" href="/contact/">Formulaire</a></nav></div></header>'
FOOT = '<footer class="foot"><div class="wrap"><p>Service indépendant d’information et de mise en relation. Pas une entreprise de plomberie ou de recherche de fuite. Informations indicatives, à faire confirmer par un professionnel qualifié.</p><p><a href="/mentions-legales/">Mentions légales</a> · <a href="/politique-confidentialite/">Confidentialité</a> · <a href="/methodologie/">Méthodologie</a></p></div></footer><a class="sticky-call" href="tel:+339****5577" aria-label="Appeler le service d’orientation au 09 72 14 55 77">Appeler le 09 72 14 55 77</a>'

COMMON_LINKS = [
    ("/recherche-fuite-eau-angers/", "guide recherche de fuite à Angers"),
    ("/recherche-fuite-non-destructive-angers/", "méthodes non destructives"),
...
"recherche-fuite-eau-angers": {
 ...
 "meta":"Guide indépendant pour recherche de fuite d’eau à Angers : symptômes, méthodes non destructives, assurance, prix et orientation sans fausse promesse.",
 ...
 "sections":[
  ...
  ("Limites et transparence", ["Aucun délai, prix ou remboursement assurance n’est garanti par ce site.", "L’objectif est de préparer une demande claire et d’éviter les mauvaises orientations.", "Un professionnel qualifié doit confirmer le diagnostic et le devis."])
 ],
 "faq":[("Qui appeler pour une recherche de fuite à Angers ?","Vous pouvez appeler un professionnel spécialisé ou utiliser ce service d’orientation indépendant pour préparer la demande. Ce site ne se présente pas comme une entreprise de plomberie."),("Une recherche de fuite est-elle toujours non destructive ?","Non. Les méthodes non destructives sont souvent privilégiées, mais leur pertinence dépend de l’accès, du type de réseau et du symptôme."),("Faut-il appeler l’assurance avant la recherche ?","En cas de dégât des eaux, il est prudent de contacter votre assurance ou syndic. La prise en charge dépend du contrat et n’est pas garantie.")]
},
"recherche-fuite-non-destructive-angers": {
 "title":"Recherche fuite non destructive Angers : méthodes et limites",
 "h1":"Recherche de fuite non destructive à Angers : méthodes, usages et limites",
 "meta":"Comprendre la recherche de fuite non destructive à Angers : caméra thermique, gaz traceur, électro-acoustique, limites et questions à poser.",
 "lead":"La recherche non destructive vise à localiser une fuite sans casser inutilement. Elle reste un diagnostic technique : la méthode dépend du réseau, du matériau, de l’accès et des symptômes.",
 "sections":[
...
"prix-recherche-fuite-eau-angers": {
 ...
 "meta":"Prix recherche fuite eau Angers : facteurs qui influencent le devis, méthodes, rapport, assurance et limites. Pas de prix fixe garanti.",
 "lead":"Le coût d’une recherche de fuite dépend du type de fuite, de l’accès, de la méthode et du besoin de rapport. Cette page aide à préparer les bonnes questions sans annoncer de prix fixe garanti.",
 "sections":[
  ...
  ("Assurance et remboursement", ["La prise en charge dépend du contrat, de la cause et du dossier.", "Demandez à l’assurance les justificatifs attendus avant intervention si possible.", "Ne considérez jamais un remboursement comme acquis avant confirmation écrite."])
 ],
 "faq":[("Existe-t-il un prix fixe pour une recherche de fuite à Angers ?","Non, pas de prix fixe garanti ici. Le tarif dépend de la situation, de la méthode et du besoin de rapport."),("L’assurance rembourse-t-elle la recherche de fuite ?","Parfois, selon contrat et circonstances. Il faut vérifier les garanties et les justificatifs demandés."),("La réparation est-elle comprise ?","Pas toujours. Demandez si le devis couvre uniquement la recherche ou aussi la réparation et la remise en état.")]
},
"recherche-fuite-assurance-angers": {
 ...
 "meta":"Recherche fuite assurance Angers : comprendre rapport, déclaration dégât des eaux, syndic, contrat et limites de prise en charge sans garantie.",
 "lead":"Après un dégât des eaux, l’assurance peut demander des éléments précis. Cette page aide à préparer les informations utiles sans promettre de remboursement ni de prise en charge automatique.",
 "sections":[
  ...
  ("Rapport de recherche de fuite", ["Un rapport peut préciser la zone, la méthode utilisée et les limites du diagnostic.", "Demandez si le rapport est inclus et s’il convient à un dossier assurance.", "Le rapport ne garantit pas à lui seul un remboursement."]),
...
"degat-des-eaux-angers": {
 ...
 "meta":"Dégât des eaux à Angers : étapes utiles, sécurité, assurance, syndic, recherche de fuite et orientation transparente sans promesse garantie.",
...
"contact": {
 ...
 "sections":[
  ...
  ("Ce que l’appel ne promet pas", ["Pas de disponibilité immédiate garantie.", "Pas de prix fixe annoncé sans devis.", "Pas de remboursement assurance garanti.", "Pas de transmission sans consentement clair."]),
 ...
 "faq":[("Le formulaire envoie-t-il des données ?","Non, le formulaire est secondaire et non connecté dans cette version locale."),("Le numéro affiché est-il le fallback OVH ?","Oui, le 09 72 14 55 77 reste le fallback tant que Twilio/Retell n’est pas approuvé et testé."),("Ce service est-il une entreprise de plomberie ?","Non, c’est un service indépendant d’information et d’orientation.")]
}
}
...
"recherche-fuite-urgence-angers": ("Recherche fuite urgence Angers : agir sans fausse promesse", "Recherche de fuite urgente à Angers : prioriser sans promesse 24/7", "Recherche fuite urgence Angers : quoi faire en cas de dégât actif, qui prévenir et comment demander une orientation sans garantie 24/7.", ["Dégât actif, voisin touché ou eau proche d’un équipement électrique.", "Besoin de limiter les dommages rapidement.", "Situation stressante nécessitant un tri clair."], ["Couper l’eau si possible.", "Contacter assurance/syndic/propriétaire selon cas.", "Appeler un professionnel adapté si danger ou dégât actif." ]),
...
def jsonld_for(slug, title, desc, faq):
    ...
    graph=[{"@type":"WebSite","@id":BASE+"/#website","url":BASE+"/","name":"Recherche Fuite Eau Angers","inLanguage":"fr-FR","description":"Service indépendant d’information et de mise en relation pour demandes de recherche de fuite à Angers et alentours."},
           ...
           {"@type":"Service","@id":url+"#service","name":title,"serviceType":"Information et orientation pour recherche de fuite d’eau","areaServed":{"@type":"City","name":"Angers"},"provider":{"@id":BASE+"/#website"},"description":"Service indépendant d’information et d’orientation, sans fausse adresse locale ni promesse d’intervention garantie."}]
    if faq:
...
<!-- END AGENT SEO HEAD --></head><body>'''
    ...
    body += f'<section class="section"><div class="wrap"><div class="card"><h2>Préparer l’appel</h2><p>Pour gagner du temps, préparez la ville/quartier, le type de fuite, l’urgence, votre statut et le besoin éventuel d’un rapport assurance.</p><p><a class="btn" href="tel:{PHONE_TEL}">Appeler le {PHONE_DISPLAY}</a> <a class="btn ghost" href="/contact/">Voir les informations à préparer</a></p><p class="note">Le numéro affiché reste le fallback OVH tant que Twilio/Retell n’est pas approuvé et testé par appel réel.</p></div></div></section></main>{FOOT}</body></html>\n'
    return head+body

def render_new(slug, data):
    title,h1,meta,signs,steps=data
    cfg={"title":title,"h1":h1,"meta":meta,"lead":"Page d’information locale pour préparer une demande liée à ce type de fuite à Angers. Le site reste un service indépendant d’orientation, sans fausse adresse ni promesse d’intervention.","sections":[("Signes typiques", signs),("Actions utiles avant diagnostic", steps),("Questions à poser avant devis", ["Quelle méthode de recherche est adaptée à ce symptôme ?", "Le rapport écrit est-il inclus si assurance ou syndic impliqué ?", "Quelles sont les limites si la fuite n’est pas localisée immédiatement ?", "La recherche est-elle distincte de la réparation ?"])],"faq":[("Cette page remplace-t-elle un diagnostic ?","Non. Elle aide à préparer les informations avant l’avis d’un professionnel qualifié."),("Le service garantit-il une intervention rapide ?","Non. Aucune disponibilité immédiate ou 24/7 n’est garantie."),("Pourquoi appeler avant de choisir une méthode ?","Parce que le symptôme, l’accès et le contexte assurance orientent fortement la méthode pertinente.")]}
...
# Homepage hub
home_cfg={"title":"Recherche fuite eau Angers : orientation indépendante","h1":"Recherche de fuite d’eau à Angers, sans fausse promesse.","meta":"Service indépendant d’information et d’orientation pour recherche de fuite d’eau à Angers : guides, méthodes, prix, assurance et appel fallback.","lead":"Comprendre votre situation, préparer les bonnes informations et être orienté sans fausse adresse, faux avis ou promesse d’intervention garantie.","sections":[("Guides prioritaires", ["Commencez par le guide recherche de fuite à Angers pour cadrer symptôme, méthode et assurance.", "Consultez le guide non destructif si vous voulez éviter une ouverture inutile.", "Lisez la page prix pour préparer les questions de devis sans attendre un prix fixe garanti.", "La page assurance aide à préparer rapport, déclaration et interlocuteurs." ]),("Situations fréquentes", ["Dégât des eaux avec voisin, syndic ou propriétaire impliqué.", "Fuite après compteur et surconsommation.", "Fuite enterrée, chauffage, plafond, appartement ou maison.", "Besoin urgent : prioriser les gestes utiles sans promesse 24/7."]),("Positionnement transparent", ["Ce site est indépendant et ne se présente pas comme un artisan local.", "Aucune adresse locale, aucun avis, aucun délai garanti n’est inventé.", "Le téléphone OVH reste fallback tant que le futur routage Twilio/Retell n’est pas validé."] )],"faq":[("Pourquoi ce site existe ?","Pour aider à qualifier une demande de recherche de fuite à Angers et préparer une éventuelle mise en relation transparente."),("Est-ce une entreprise de plomberie ?","Non. C’est un service indépendant d’information et d’orientation."),("Puis-je appeler maintenant ?","Oui, le numéro OVH fallback est affiché, sans garantie d’intervention immédiate.")]}
(SITE/'index.html').write_text(render('', home_cfg).replace(BASE+'//',BASE+'/'),encoding='utf-8')

# Methodologie hub
method_cfg={"title":"Méthodologie : transparence du service d’orientation","h1":"Méthodologie et transparence du site", "meta":"Méthodologie du service indépendant : information, orientation, limites, absence de fausse entreprise locale et critères de contenu white-hat.", "lead":"Cette page explique comment le site traite les demandes de recherche de fuite à Angers sans se présenter comme une fausse entreprise locale.", "sections":[("Ce que le site fait", ["Organiser l’information utile par situation : fuite, assurance, prix, méthodes.", "Aider à préparer un appel ou une demande claire.", "Créer un maillage local white-hat autour des intentions réelles.", "Conserver un langage prudent tant qu’aucun partenaire n’est validé." ]),("Ce que le site ne fait pas", ["Pas de fausse adresse locale.", "Pas de faux avis ni fausse preuve sociale.", "Pas de promesse 24/7, prix fixe ou remboursement garanti.", "Pas de claim “nos artisans” ou “notre entreprise de plomberie”."]),("Contrôle qualité", ["Chaque page doit avoir title, meta, H1, canonical et JSON-LD parsable.", "Les pages importantes doivent recevoir des liens internes contextuels.", "Les contenus doivent aider un propriétaire, locataire ou syndic à Angers."] )], "faq":[("Pourquoi éviter LocalBusiness ?","Parce que le site ne doit pas inventer une entreprise locale, une adresse ou des avis."),("Pourquoi parler d’orientation ?","C’est la formulation transparente tant que le site sert à qualifier et diriger les demandes."),("Comment le site évoluera ?","Le téléphone Twilio/Retell ne sera publié qu’après approbation réglementaire et test entrant réel.")]}
